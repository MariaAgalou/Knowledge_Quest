...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "The underwater realm is a glowing, ancient seabed of ruins and coral, where drifting jellyfish, darting fish, and hidden treasures shimmer beneath tranquil, mysterious waters."
