...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "A sprawling stone dungeon lies beneath the earth: torchlit halls, flooded chambers, collapsed bridges, and glowing lava fissures forming a dangerous maze of ancient ruin."
