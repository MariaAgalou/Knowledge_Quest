...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "An ancient stone maze, choked with moss and roots, twists through crumbling walls and shadowed paths, hiding forgotten debris and silent dangers."
