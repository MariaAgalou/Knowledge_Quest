...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "A cozy riverside village with thatched cottages, bustling market stalls, a warm tavern, and a quiet church, surrounded by golden fields and forest paths, humming with peaceful rural life."
