...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "The hero enters a winding orchard of blooming trees and heavy fruit, where petal-strewn paths weave past cottages, flowers, and a quiet river humming with spring."
