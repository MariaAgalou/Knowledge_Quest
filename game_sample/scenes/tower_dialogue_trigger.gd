...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "A crumbling circular tower interior spirals downward, moss-choked stones, broken beams, scattered chests, and dusty windows admitting pale light over a yawning central shaft."
