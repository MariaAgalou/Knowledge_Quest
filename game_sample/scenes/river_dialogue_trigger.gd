...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "A winding blue river cuts through lush pixelated grasslands, its gentle currents bordered by wildflowers, stones, and soft earthen banks."
