...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "The tranquil blue lake encircles a tiny island with a lone tree, cottage, campfire, and docked boat, surrounded by forest trails, flowers, and peaceful village scenery."
