...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "Crumbling stone walls and vine-choked arches surround forgotten camps and broken statues, while a narrow stream cuts through the jungle, whispering of lost civilizations."
