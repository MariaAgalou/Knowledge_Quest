...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "A winding dirt path snakes through an ancient forest of mossy ruins, gnarled roots, glowing mushrooms, and a murmuring stream crossed by a weathered wooden bridge."
