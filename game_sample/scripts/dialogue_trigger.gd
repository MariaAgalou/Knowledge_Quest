...
func show_dialogue():
	...
	if dialogue_box:
		dialogue_box.text = "The hero steps into a sprawling stone castle: a regal throne hall flanked by kitchens, barracks, treasury, and libraries, all bustling with guards and courtiers."
