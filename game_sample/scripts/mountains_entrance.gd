...
func _on_mouse_entered():
	glow.visible = true
	level.text = "Level 2: The Mountains"
	level.visible = true
	level2.text = "Level 2: The Mountains"
	level2.visible = true
	...
	if GameState.castle_level_completed:
		...
		text.text = "Complete level 1: The Castle first!"
		text2.text = "Complete level 1: The Castle first!"
		text.visible = true
		text2.visible = true
...
func _input_event(_viewport, event, _shape_idx):
	if GameState.castle_level_completed:
		if event is InputEventMouseButton and event.pressed:
			...
			SceneManager.change_scene("res://scenes/insidemountains.tscn")
			Input.set_default_cursor_shape(Input.CURSOR_ARROW)
